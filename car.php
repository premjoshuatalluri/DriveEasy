                                ...
                                <div class="car-card">
                                    <div class="card-body">
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-4">
                                                <p class="title-sm fs-12 mb-1"> Miles Driven: <span class="text-dark fw-bold"> <?=$car['kms_driven'];?></span> </p>
                                            </div>
                                        </div>
                ...
                <div class="col-md-4">
                    <div class="car-card sticky2">
                        ...
                        ?>
                            ...
                            <h5 class="title1 fs-16 mb-1">Convenience Fee <span class="float-end">£9</span></h5>
                            <?php 
