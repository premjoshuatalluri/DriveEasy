...
if (isset($_POST['updateProfile'])) {
    ...
    if ($name != '' || $email != '' || $password != '') {
        ...
        if ($result) {
            redirect('profile-edit.php?id=' . $userId, 'Profile Updated Successfully');
        } else {
            redirect('profile-edit.php?id=' . $userId, 'Something Went Wrong');
        }
    } else {
        redirect('profile-edit.php?id=' . $userId, 'Please fill required fields!');
    }
}
