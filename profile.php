                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="id_proof_type" class="form-select" required>
                                            ...
                                            <option value="Aadhar"  <?= $user['data']['id_proof_type'] == 'Aadhar' ? 'selected':''; ?> >Passport</option>
                                            <option value="PAN"  <?= $user['data']['id_proof_type'] == 'PAN' ? 'selected':''; ?> >ID</option>
                                            <option value="Voter"  <?= $user['data']['id_proof_type'] == 'Voter' ? 'selected':''; ?> >Bills</option>
                                        </select>
                                    </div>
                                </div>
